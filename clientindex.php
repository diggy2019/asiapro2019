...
<html lang="en">
    <head>
        ...
        <!-- Timeline CSS -->
        <link href="imports/css/timeline.css" rel="stylesheet">

        <!-- Custom CSS -->
        <link href="imports/css/startmin.css" rel="stylesheet">

        <!-- Morris Charts CSS -->
        <link href="imports/css/morris.css" rel="stylesheet">
    ...
    <body>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-xs-3">
                                            <i class="fa fas fa-building fa-5x"></i>
                                        </div>
                                        <?php $query = mysqli_query($con,"SELECT COUNT(branch_id) as count from branch WHERE branch_id = '$id'");
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="panel panel-green">
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-xs-3">
                                            <i class="fa fas fa-user fa-5x"></i>
                                        </div>
                                        <?php $query = mysqli_query($con,"SELECT COUNT(employee_id) as count, branch.branch_id from employees INNER JOIN branch on branch.branch_id=employees.branch_id WHERE branch.branch_id = '$id'");
                                            $row = mysqli_fetch_assoc($query); ?>
                                        <div class="col-xs-9 text-right">
                                            <div class="huge"><?php echo $row['count']; ?></div>
                                            <div>Employees</div>
        ...
        <script src="imports/js/raphael.min.js"></script>
        <script src="imports/js/morris.min.js"></script>
        <script src="imports/js/morris-data.js"></script>
